...
## Platforms Built & Managed — From Scratch

| Platform | Role | Stack |
|---|---|---|
| [CIEL HR](https://www.cielhr.com) | Lead Developer & Digital Architect | PHP, WordPress, Cloudflare, Zoho, AWS |
...
- Engineered **390+ high-performing SEO landing pages** with keyword-to-page pipeline targeting India-wide organic traffic
- Full technical stack: Core Web Vitals, WebP conversion, LiteSpeed + Cloudflare caching, GA4 + GTM server-side tracking
...
- Claude Code in Action (AI & Agentic Workflows) — **Anthropic**
- Cyber Investigator: An Interactive Cybersecurity Experience — **IBM**
- SEO Certified (Advanced Technical & On-Page) — **HubSpot Academy**
